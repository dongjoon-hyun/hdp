...
slaves.sh /usr/hdp/2.5.5.0-157/hadoop/sbin/hadoop-daemon.sh --script hdfs start datanode

yarn-daemon.sh start resourcemanager
slaves.sh /usr/hdp/2.5.5.0-157/hadoop-yarn/sbin/yarn-daemon.sh start nodemanager
