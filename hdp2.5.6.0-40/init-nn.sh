...
slaves.sh /usr/hdp/2.5.6.0-40/hadoop/sbin/hadoop-daemon.sh --script hdfs start datanode

yarn-daemon.sh start resourcemanager
slaves.sh /usr/hdp/2.5.6.0-40/hadoop-yarn/sbin/yarn-daemon.sh start nodemanager
