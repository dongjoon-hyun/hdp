...
slaves.sh /usr/hdp/2.6.4.0-91/hadoop/sbin/hadoop-daemon.sh --script hdfs start datanode

yarn-daemon.sh start resourcemanager
slaves.sh /usr/hdp/2.6.4.0-91/hadoop-yarn/sbin/yarn-daemon.sh start nodemanager
