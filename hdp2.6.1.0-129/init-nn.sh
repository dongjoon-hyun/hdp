...
slaves.sh /usr/hdp/2.6.1.0-129/hadoop/sbin/hadoop-daemon.sh --script hdfs start datanode

yarn-daemon.sh start resourcemanager
slaves.sh /usr/hdp/2.6.1.0-129/hadoop-yarn/sbin/yarn-daemon.sh start nodemanager
