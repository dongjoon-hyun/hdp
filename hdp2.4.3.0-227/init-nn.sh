...
slaves.sh /usr/hdp/2.4.3.0-227/hadoop/sbin/hadoop-daemon.sh --script hdfs start datanode

yarn-daemon.sh start resourcemanager
slaves.sh /usr/hdp/2.4.3.0-227/hadoop-yarn/sbin/yarn-daemon.sh start nodemanager
